...
export function TabContainer({
  ...
  return (
    <div>
      {/* Tab Navigation */}
      <div data-tour="tab-navigation" className="flex border-b border-white/15 mb-6 overflow-x-auto scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
        <button
