#!/usr/bin/env python3
"""Compute normalization stats for the AE + dynamic_world experiment."""
...
from build_sinr_v52_ae_dynamic_world_feature_contract import ENV_CONTINUOUS_COLS
...
def main() -> None:
    ...
    cont_path = out_dir / "normalize_stats_v52_ae_dynamic_world.npz"
    temp_path = out_dir / "normalize_temporal_v52_ae_dynamic_world.npz"
    manifest_path = out_dir / "stats_contract_v52_ae_dynamic_world.json"
    ...
    manifest = {
        "contract_name": "sinr_v52_ae_dynamic_world_normalization",
        "version": "v52_ae_dynamic_world",
