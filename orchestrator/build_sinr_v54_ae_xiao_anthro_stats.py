#!/usr/bin/env python3
"""Compute normalization stats for the AE + xiao + anthropogenic-context experiment."""
...
from build_sinr_v54_ae_xiao_anthro_feature_contract import ENV_CONTINUOUS_COLS
...
def main() -> None:
    ...
    cont_path = out_dir / "normalize_stats_v54_ae_xiao_anthro.npz"
    temp_path = out_dir / "normalize_temporal_v54_ae_xiao_anthro.npz"
    manifest_path = out_dir / "stats_contract_v54_ae_xiao_anthro.json"
    ...
    manifest = {
        "contract_name": "sinr_v54_ae_xiao_anthro_normalization",
        "version": "v54_ae_xiao_anthro",
